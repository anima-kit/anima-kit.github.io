...
# :material-chart-box-multiple-outline:{ .icon-def-0 } Machine Learning

!!! tl-dr "TL;DR"
    Learn some of the `fundamental concepts` of ML with interactive notebooks. Dive into the tutorials below or keep scrolling to learn more :material-arrow-down-bold-outline:{ .icon-def-0 }.
...
## :material-map-marker-question-outline:{ .icon-def-0 } What is Machine Learning?
