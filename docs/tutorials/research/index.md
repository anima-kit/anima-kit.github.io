...
# :material-book-search-outline:{ .icon-def-0 } Research

!!! welcome "Hiya"
    Stay up to date with current AI research :material-arrow-down-bold-outline:{ .icon-def-0 }.

<hr class="icon-def-1 tertiary-icon", style="width: 90%;"> 

<div class="grid cards" markdown>

-   :material-medication-outline:{ .icon-def-0 } Medical AI
